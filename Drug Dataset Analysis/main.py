...
# distance from first index where data appears
startat = 1
# distance backwards from last index where data appears
stopat = 0
...
def preprocess(target, fname='Dataset Correlated Removed.csv'):
    """
