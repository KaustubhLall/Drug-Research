...
\documentclass[11pt]{article}
    ...
    \def\lt{<}
    % Document parameters
    \title{data visualization and preprocessing}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{n}{datamatrix} \PY{o}{=} \PY{n}{DataContainer}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{FINAL 102518 All Unique Metab KO.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{dataMatrix}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{n}{correlations} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
        ...
        \PY{k}{for} \PY{n}{col\PYZus{}a}\PY{p}{,} \PY{n}{col\PYZus{}b} \PY{o+ow}{in} \PY{n}{itertools}\PY{o}{.}\PY{n}{combinations}\PY{p}{(}\PY{n}{columns}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{:}
            \PY{n}{correlations}\PY{p}{[}\PY{n+nb}{str}\PY{p}{(}\PY{n}{col\PYZus{}a}\PY{p}{)} \PY{o}{+} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZus{}\PYZus{}}\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{col\PYZus{}b}\PY{p}{)} \PY{o}{+}  \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{(}\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s2}{\PYZdq{}} \PY{o}{\PYZpc{}} \PY{n}{header}\PY{p}{[}\PY{n}{col\PYZus{}a}\PY{p}{]} \PY{o}{+}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}}\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s2}{)}\PY{l+s+s2}{\PYZdq{}} \PY{o}{\PYZpc{}} \PY{n}{header}\PY{p}{[}\PY{n}{col\PYZus{}b}\PY{p}{]}\PY{p}{]} \PY{o}{=} \PY{n}{pearsonr}\PY{p}{(}\PY{n}{df}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{n}{col\PYZus{}a}\PY{p}{]}\PY{p}{,} \PY{n}{df}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{n}{col\PYZus{}b}\PY{p}{]}\PY{p}{)}
...
Discard: 7, 5, 1, 16, 20, 23, 9, 17, 10 (molVolume, molArea, nof_Atoms, nof_HBA, nof_HBD, a_heavy, C_R2, C_sp3, nof_RotB)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{todel}\PY{o}{=} \PY{p}{[}\PY{l+m+mi}{7}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{16}\PY{p}{,} \PY{l+m+mi}{20}\PY{p}{,} \PY{l+m+mi}{23}\PY{p}{,} \PY{l+m+mi}{9}\PY{p}{,} \PY{l+m+mi}{17}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{features removed}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
